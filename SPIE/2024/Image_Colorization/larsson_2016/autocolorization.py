...
for current_frame in os.listdir('./input/landscape_64x64_bw/'):
    print current_frame
    img_rgb = caffe.io.load_image('./input/landscape_64x64_bw/'+str(current_frame))
    ...
    #scipy.misc.imsave
    scipy.misc.imsave('./output/'+str(current_frame), img_rgb_out)
    #plt.axis('off');
